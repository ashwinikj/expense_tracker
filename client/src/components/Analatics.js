...
function Analatics({ transactions }) {
    ...
    const totalExpenceTransactions = transactions.filter((transaction) => transaction.type === "expense");
    ...
    const totalExpenceTurnover = transactions.filter((transaction) => transaction.type === "expense").reduce((acc, transaction) => acc + transaction.amount, 0);
  ...
  return (
    <div className='analytics'>
        <div className='row mt-5'>
            ...
            <div className='col-md-4 mt-3'>
                <div className='transactions-count'>
                <h4>Total totalTurnover : {totalTurnover}</h4>
                <hr />
